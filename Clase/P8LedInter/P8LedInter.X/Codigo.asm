;LED INTERMITENTE EN RD5
    ...
    #DEFINE LED PORTD,RD5
    
    ORG	.0
    
    SETTING	BCF	TRISD,5  ;SALIDA RF5
		CLRF	PORTD
		MOVLW	B'11000111'
		MOVWF	T0CON
    ...
    DELAY	
		CLRF	TMR0L
		MOVLW	.159  ;COMPLEMENTO DE 256 (98 CONTEOS)
		MOVWF	TMR0L
    
    ASK	
		BTFSS	INTCON,TMR0IF   ;SUBE LA BANDERA
		BRA	ASK
		BSF	INTCON, TMR0IF  ;BAJA LA BANDERA
		RETURN
