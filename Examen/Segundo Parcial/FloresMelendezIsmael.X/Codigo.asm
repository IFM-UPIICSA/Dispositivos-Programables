;Sistema que controle la operación de una alarma colocada en un local comercial
;Ismael Flores Melendez
    LIST P=18F4550
    #INCLUDE <P18F4550.INC>
    
    #DEFINE	PUERTAS	    PORTB
    #DEFINE	ALARMA	    PORTB   RB0
    #DEFINE	SILENCIAR   PORTB   RD3
    #DEFINE	LEDALARMA   PORTD   RD2
